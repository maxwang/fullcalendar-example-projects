...
import { View,
  ...
  htmlEscape,
  buildGotoAnchorHtml,
  createFormatter } from '@fullcalendar/core';
...
import DayGridDateProfileGenerator from '@fullcalendar/daygrid';

const WEEK_NUM_FORMAT = createFormatter({ week: 'numeric' });
export default abstract class TenDaysGridView extends View {

  scroller: ScrollComponent;
  dayGrid: TenDaysGrid; // the main subcomponent that does most of the heavy lifting
  ...
  renderDayGridNumberIntroHtml = (row: number, dayGrid: TenDaysGrid) => {
    let { dateEnv } = this
...
// TenDaysGridView.prototype.dateProfileGeneratorClass = DayGridDateProfileGenerator;
